...
use PhpPp\Core\Contract\Collection\ScalarNullableCollectionInterface;

class ScalarNullableCollection extends AbstractScalarCollection implements ScalarNullableCollectionInterface
{
    /** @return static */
